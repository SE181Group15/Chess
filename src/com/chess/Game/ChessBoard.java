...
public class ChessBoard {
    ...
    public ChessBoard(NamedColor p1Color, NamedColor p2Color) {
        ...
        // Place Queens
        board[0][3 + (Settings.reverseOrder ? 1 : 0)] = new Queen(playerColor, 2);
        board[7][3 + (Settings.reverseOrder ? 1 : 0)] = new Queen(otherPlayerColor, 1);
        // Place Kings
        board[0][4 - (Settings.reverseOrder ? 1 : 0)] = new King(playerColor, 2);
        board[7][4 - (Settings.reverseOrder ? 1 : 0)] = new King(otherPlayerColor, 1);
        // Place Rooks
